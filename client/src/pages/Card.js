...
const handleClick = async () => {
   ...
   try {
    const deletejson = await axios.delete("https://therumorsonly.onrender.com/" + rumor._id)
...
const likeHandler = () => {
  ...
  try {
    axios.put("https://therumorsonly.onrender.com/" + rumor._id + "/like", { theId: user._id });
  } catch (err) {}
